...
public class Scripture {
  ...
  /**
   * Call before using the class. Sets a list of valid scriptures for matching.
   * 
   * @param validBooks
   */
  ...
  /**
   * Construct a scripture from a book chapter and verse. Chapter and verse are
   * ints.
   * 
   * @param book
   * @param chapter
  ...
  /**
   * Returns a string that includes verse only if one is provided. And a chapter
   * if one is provided. Possible outputs: John 3:4 John 3 John
   * 
   * @return String
   */
