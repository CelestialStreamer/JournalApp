...
public class Entry {
  ...
  /**
   * Initialize with string content and string date. No verification of any kind
   * is made.
   * 
   * @param content
   * @param date
  ...
  /**
   * Returns a list of topics. This is the same list that was set when the class
   * was initialized.
   * 
   * @return
   */
  ...
  /**
   * Returns a string in the format of Date: <date> Content: <content>
   * 
   */
